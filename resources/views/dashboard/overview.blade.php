        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header d-block border-0 pb-0">
                            <h2 class="card-title mb-1">Deposit Analysis</h2>
                        </div>
                        <div class="card-body py-0">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex px-0 justify-content-between align-items-center">
                                    ...
                                    <div class="w-100 ml-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <p class="mb-0 text-black font-w600">Total Deposit</p>
                                            <span class="ml-auto fs-18 mb-0  text-black font-w600">&#163;{{ $total ? : "0.00" }}</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item d-flex px-0 justify-content-between align-items-center">
                                    ...
                                    <div class="w-100 ml-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <p class="mb-0 text-black font-w600">Approved Deposit</p>
                                            <span class="ml-auto fs-18 mb-0  text-black font-w600">&#163;{{ $approved_cash ? : "0.00" }}</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item d-flex px-0 justify-content-between align-items-center">
                                    ...
                                    <div class="w-100 ml-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <p class="mb-0 text-black font-w600">Pending Deposit</p>
                                            <span class="ml-auto fs-18 mb-0  text-black font-w600">&#163;{{ $pending_cash ? : "0.00" }}</span>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header d-block border-0 pb-0">
                            <h2 class="card-title mb-1">Withdrawal Analysis</h2>
                        </div>
                        <div class="card-body py-0">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex px-0 justify-content-between align-items-center">
                                    ...
                                    <div class="w-100 ml-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <p class="mb-0 text-black font-w600">Total Withdrawal</p>
                                            <span class="ml-auto fs-18 mb-0  text-black font-w600">&#163;{{ $total_withdraw ? : "0.00" }}</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item d-flex px-0 justify-content-between align-items-center">
                                    ...
                                    <div class="w-100 ml-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <p class="mb-0 text-black font-w600">Approved Withdrawal</p>
                                            <span class="ml-auto fs-18 mb-0  text-black font-w600">&#163;{{ $withdraw_approved_cash ? : "0.00" }}</span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item d-flex px-0 justify-content-between align-items-center">
                                    ...
                                    <div class="w-100 ml-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <p class="mb-0 text-black font-w600">Pending Withdrawal</p>
                                            <span class="ml-auto fs-18 mb-0  text-black font-w600">&#163;{{ $withdraw_pending_cash ? : "0.00" }}</span>
                                        </div>
                                    </div>
                                </li>

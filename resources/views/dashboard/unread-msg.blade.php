                        ...
                        <div class="card-body">
                            <div class="email-left-box px-0 mb-3">
                                <div class="mail-list mt-4">
                                    <a href="email-inbox.html" class="list-group-item "><i class="fa fa-inbox font-18 align-middle mr-2"></i> Inbox <span class="badge badge-primary badge-sm float-right">{{ $all_messages }}</span> </a>
                                    {{--                                    <a href="javascript:void()" class="list-group-item"><i class="fa fa-paper-plane font-18 align-middle mr-2"></i>Read</a> --}}

                                    <a href="{{ route('user.uread_messages') }}" class="list-group-item active"><i class="mdi mdi-file-document-box font-18 align-middle mr-2"></i>Unread <span class="badge badge-danger text-white badge-sm float-right">{{ $unread_msg }}</span></a>

                                ...
                                <form action="{{ route('admin.packages.store') }}" method="POST">
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" name="min_deposit" class="form-control" id="inputAmount" placeholder="Min Amount">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputMax">Max Amount</label>
                                            <input type="number" name="max_deposit" class="form-control" id="inputMax" placeholder="Max Amount">
                                        </div>
                                    </div>
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
